...
//		System.out.println(strs.length);
	...
	public int ladderLength(String start, String end, HashSet<String> dict) {
		...
		for(String s : dict) visit.put(s, false);
		...
		while(!toCheck.contains(end) && toCheck.size() > 0){
			...
			for(String s : toCheck){
				newStrs.addAll(oneDiffStrs(s, dict, visit));
			}
			toCheck = newStrs;
		}
		if(toCheck.contains(end)) return result;
		else return 0;
	}
	
	public List<String> oneDiffStrs(String str, HashSet<String> dict, Map<String, Boolean> visit){
...
// This implementation meets Time Limit Exceeded
//    public static int ladderLength(String start, String end, HashSet<String> dict) {
//    	if(!dict.contains(start) || !dict.contains(end)) return 0;
//    	Map<String, List<Integer>> word2similar = new HashMap<String, List<Integer>>();
//        String[] words = new String[dict.size()];
//        int[] degrees = new int[dict.size()];
//        int[] visit = new int[dict.size()];
//        int index = 0, b = -1, e = 0;
//        
//        for(String s : dict){
//        	if(s.equals(start)) b = index;
//        	words[index++] = s;
//        	List<Integer> list = new ArrayList<Integer>();
//        	word2similar.put(s, list);
//        }
//        
//        for(int i = 0; i < dict.size(); i++){
//        	for(int j = i + 1; j < dict.size(); j++){
//        		if(isSimilar(words[i], words[j])){
//        			word2similar.get(words[i]).add(j);
//        			word2similar.get(words[j]).add(i);
//        		}
//        	}
//        }
//        
...
//        while(b < e){
//        	b++;
//        	for(int i : word2similar.get(words[visit[b]])){
//        		if(degrees[i] == 0){
//        			visit[++e] = i;
//        			degrees[i] = degrees[visit[b]] + 1;
